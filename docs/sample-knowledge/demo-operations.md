...
The Makefile is the main operator interface. `make up` starts the full stack, waits for health checks, and prints the local resource map. `make down` stops the full stack without deleting volumes.
